...
class LowVoltageWindow(QMainWindow):
    ...
    def createMenus(self):
        ...
        fileMenu.addAction(self.createAct(None,'Save &As...', 'Ctrl+Shift+S', "Save file as...", self.onFileSaveAs))
        fileMenu.addSeparator()
        fileMenu.addAction(self.createAct(":/icons/quit.png",'E&xit', 'Ctrl+Q', "Exit application", self.close))
        # Edit Menu
        editMenu = menubar.addMenu('&Edit')
        editMenu.addSeparator()
        editMenu.addAction(self.createAct(":/icons/gomme.png",'&Delete', 'Del', "Delete selected items", self.onEditDelete))

    # Function create Toolbar
    def createToolbar(self):
        # Controller to create element
        self.creaToolBar = self.addToolBar("Creation")
        self.creaToolBar.addAction(self.createAct(":/icons/node.png",'&Node', '', "Bracket creation", self.onEditDelete))
        self.creaToolBar.addAction(self.createAct(":/icons/user.png", '&User', '', "User creation", self.onEditDelete))
        self.creaToolBar.addAction(self.createAct(None, '&Line', '', "Line creation", self.onEditDelete))
        ...
        self.xcvToolBar.addAction(self.createAct(None, '&Cut', 'Ctrl+X', "Cut to clipboard", self.onEditCut))
        self.xcvToolBar.addAction(self.createAct(None, '&Copy', 'Ctrl+C', "Copy to clipboard", self.onEditCopy))
