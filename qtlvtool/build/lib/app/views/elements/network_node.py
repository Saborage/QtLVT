...
from app.views.graphics.network_graphics_node import QDMGraphicsNode
from app.views.widgets.network_content_widget import QDMNetworkContentWidget
from app.views.elements.network_socket import *
...
class Node(Serializable):
    def __init__(self, scene, title="Undefined Node", inputs=[], outputs=[]):
        ...
        self.content = QDMNetworkContentWidget(self)
